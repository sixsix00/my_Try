...
FB.logout(function(response) {
   // Person is now logged out
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <c:if test="${! empty loginOK }">
	                    <li class="nav-item dropdown mx-1">
	                        <a href="infoPage" class="nav-link mx-3">
	                            <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" class="bi bi-person-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	                                    <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
	                                    <path fill-rule="evenodd" d="M2 15v-1c0-1 1-4 6-4s6 3 6 4v1H2zm6-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
	                                  </svg>
         ...
         <c:if test="${ empty loginOK } " >
                    	<li>
                    	<a class="btn btn-outline-primary" href="registPage" role="button">會員註冊</a>
                    	</li>
                    </c:if>
                    <c:if test="${! empty loginOK }">
                    	<li></li>
       ...
       <!-- 登出 -->
      <c:if test="${! empty loginOK }">
	       <li class="nav-item dropdown mx-1" id="logout" onclick="FB.logout()">
				 <a href="memberLogout.controller" method="post">登出</a>
	       </li>
	  </c:if>
    </nav>
