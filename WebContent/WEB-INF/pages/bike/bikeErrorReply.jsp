		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<div class="row">
					...
					<form class="w-75 m-auto" action="bikeErrorReply.controller" method="post">
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip02">序號</label> <input type="text"
									class="form-control" id="validationTooltip02" value="${changeid}"
									name="id" required readonly="readonly"/>
							</div>
						</div>
...
<%-- 														<input type="hidden" name="status" value="${param.status}"> --%>
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">問題主旨</label> <input type="text"
									class="form-control" id="validationTooltip05" name="title" value="${param.title}"
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">狀態</label>
								<select name="status" class="form-control" id="validationDefault05">
      								<option value="處理中">處理中</option>>
	    							<option value="已結案">已結案</option>>
	  							</select>
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">問題類型</label> 
								<select  class="form-control" id="validationTooltip05" name="tag">
									<option value="${param.tag}">${param.tag}</option>>
...
<!-- 							<div class="col-md-12 mb-3"> -->
								<label for="validationTooltip04">問題描述</label> 
								<textarea class="form-control" id="validationTooltip05" name="description" readonly="readonly">${param.description}</textarea>
<!-- 								<input type="text" -->
<!-- 									class="form-control" id="validationTooltip05" name="reply" /> -->
<!-- 							</div> -->
		
						</div>
						<div class="form-group">
								<label for="validationTooltip04">回覆</label> 
								<textarea class="form-control" id="validationTooltip05" name="reply"></textarea>
