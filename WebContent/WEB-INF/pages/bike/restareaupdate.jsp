...
<body class="white-content">
	...
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<div class="row">
					...
					<form class="w-75 m-auto" action="REUpdate.controller"
						method="post">
						<div class="form-row">
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">驛站名稱</label> <input type="text"
									class="form-control" id="validationTooltip05" name="name"
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								...
								<select name="city" class="form-control" id="validationDefault05">
	    ...
	    <option value="金門縣">金門縣</option>>
							...
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">區域</label> <input type="text"
									class="form-control" id="validationTooltip05" name="town" value="${param.town}" />
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">地址</label> <input type="text"
									class="form-control" id="validationTooltip05" name="address" value="${param.address}" />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">電話</label> <input
