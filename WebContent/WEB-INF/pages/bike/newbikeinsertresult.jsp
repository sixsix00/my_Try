									...
									<table class="table tablesorter " id="">
										...
										<tbody>
											<tr>
												...
												<td>${insert.name}</td>
												<td>${insert.begin}</td>
												<td class="text-center">${insert.goal}</td>
												<td class="text-center">${insert.city}</td>
												<td class="text-center">${insert.town}</td>
												<td class="text-center">${insert.maintain}</td>
												<td class="text-center">${insert.m}</td>
												<td class="text-center">${insert.latitude}</td>
												<td class="text-center">${insert.longitude}</td>
												<form action="<c:url value='/bikeMgrUpdateEntry.controller'/>" method="post">
														<input type="hidden" name="changeid" value="${insert.id}">
														<input type="hidden" name="name" value="${insert.name}">
														<input type="hidden" name="begin" value="${insert.begin}">
														<input type="hidden" name="goal" value="${insert.goal}">
														<input type="hidden" name="city" value="${insert.city}">
														<input type="hidden" name="town" value="${insert.town}">
														<input type="hidden" name="maintain" value="${insert.maintain}"> 
														<input type="hidden" name="m" value="${insert.m}"> 
														<input type="hidden" name="latitude" value="${insert.latitude}">
														<input type="hidden" name="longitude" value="${insert.longitude}"> 
												<td class="text-right"><input type="submit" class="btn btn-success my-2 my-sm-0" name="update" value="修改">
												</form>
												<input type="button" class="btn btn-danger my-2 my-sm-0 " value="刪除" name="${insert.id}" onclick="Delete(this)">
												</td>
											</tr>
