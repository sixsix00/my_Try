	...
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<div class="row">
					...
					<form class="w-75 m-auto" action="bikeInsert.controller"
						method="post">
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<label for="validationTooltip04">道路名稱</label> <input type="text"
									class="form-control" id="name" name="name"
									required />
							</div>
							<div class="col-md-3 mb-3">
								<label for="validationTooltip05">起點</label> <input type="text"
									class="form-control" id="begin" name="begin"
									required />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">終點</label> <input type="text"
      ...
      <option value="台北市">台北市</option>>
	    ...
	    <option value="金門縣">金門縣</option>>
						...
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<label for="validationTooltip04">管理單位</label> <input type="text"
									class="form-control" id="maintain" name="maintain" />
							</div>
							<div class="col-md-3 mb-3">
								<label for="validationTooltip05">總長(M)</label> <input
									type="text" class="form-control" id="m"
									name="m" />
							</div>
							<div class="col-md-3 mb-3">
						...
						<button class="btn btn-success my-2 my-lg-3" type="button" id="add" >一鍵輸入</button> 
						<br>
					</form>
				</div>
	...
	<script>
			$(function(){
				...
				$("#add").on("click",function(){//一鍵輸入
					$("#name").val("追風者");
					$("#begin").val("桃園市中壢區中大路300號");
					$("#goal").val("桃園市中壢區中和路139號");
					$("#city").val("桃園市");
					$("#town").val("中壢區");
					$("#maintain").val("追風者");
					$("#m").val("2020");
					$("#latitude").val("24.9672449");
					$("#longitude").val("121.1921689");
