					...
					<div class="col-md-12">
						...
						<div class="card ">
							<div class="card-header">
								<h3 class="card-title">${changeid}</h3>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table tablesorter " id="">
										...
										<tbody>
										<c:set var="detail" value="${queryResult}">
											...
											<tr>
												...
												<td>${param.name}</td>
												<td>${param.city}</td>
												<td class="text-center">${param.town}</td>
												<td class="text-center">${param.begin}</td>
												<td class="text-center">${param.goal}</td>
												<td class="text-center">${param.maintain}</td>
												<td class="text-center">${param.m}</td>
												<td class="text-center">${param.latitude}</td>
												<td class="text-center">${param.longitude}</td>
												<form action="<c:url value='/bikeMgrUpdateEntry.controller'/>" method="post">
														...
														<input type="hidden" name="town" value="${param.town}">
														<input type="hidden" name="maintain"
															value="${param.maintain}"> <input type="hidden"
															name="m" value="${param.m}"> <input
															type="hidden" name="latitude" value="${param.latitude}">
														<input type="hidden" name="longitude"
															value="${param.longitude}">
												<td class="text-right"><input type="submit" class="btn btn-success my-2 my-sm-0  " value="修改">
												</form>
													<input type="button" class="btn btn-danger my-2 my-sm-0 " value="刪除" name="${changeid}" onclick="Delete(this)"></td>
											</tr>
