							...
							<div class="card-body">
								<div class="table-responsive">
										...
										<table class="table tablesorter " id="">
											<thead class=" text-primary">
												<tr>
													...
													<a	class="btn btn-secondary my-2 my-sm-0  "	
														href=<c:url value='/insertBikeStockPre?storeId=${store.store_id}'/>>
														<svg width="1em"
											...
											<tbody>
											<c:forEach var="stockBean" items="${stockBean}">
											
												<tr>
													<td>${stockBean.rentalBike.simBike.rbType.typeName}</td>
													<td>${stockBean.rentalBike.simBike.rbName}</td>
													<td>${stockBean.rentalBike.rbSize.rbSize}</td>
													<td>${stockBean.rbStock}</td>
													<td class="text-right">
														<input class="btn btn-success my-2 my-sm-0" type="button" value="修改"  onclick="javascript:location.href='insertBikeStockPre?storeID=<c:out value="${stockBean.store.st_name}"/>'"/>
														<input class="btn btn-danger my-2 my-sm-0" type="button" value="刪除"   onclick="javascript:location.href='storeDelete.controller?storeID=<c:out value="${stockBean.store.st_name}"/>'">
												</tr>
											</c:forEach>
