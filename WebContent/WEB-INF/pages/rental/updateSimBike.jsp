		...
		<div class="main-panel">
			...
			<div class="content">
				<div
					...
					<!-- TABLE名稱 -->
					<h1 class="h2">腳踏車管理</h1>

				</div>
				<div class="row">

					<form:form id="bikeForm" class="needs-validation w-75 m-auto"  enctype="multipart/form-data"
						action="UpdateSimBike" method="post" modelAttribute="simBikeTypeBean">
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<form:label path="simRbId" for="validationTooltip02">腳踏車代碼</form:label> 
								<form:input type="text" class="form-control" path="simRbId" readonly="true"/>
							</div>							
							<div class="col-md-3 mb-3">
								<form:label path="rbName" for="validationTooltip04">腳踏車種類名稱</form:label> 
								<form:input type="text" class="form-control" path="rbName" required="required"/>
							</div>
							<form:input type="hidden" class="form-control" path="rbType.typeId"/>
...
<!-- 		上傳圖片用 -->
				...
				<div class="form-row">
					<div class="col-md-3 mb-3">
					<form:label path="rbImg" for="validationTooltip04">上傳圖片</form:label>
