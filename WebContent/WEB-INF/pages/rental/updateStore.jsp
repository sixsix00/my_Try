			...
			<div class="content">
				...
				<div class="row">
					...
					<form class="needs-validation w-75 m-auto"
						action="storeUpdate.controller" method="post" enctype="multipart/form-data" onsubmit="return confirm('確定要修改嗎？')">
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<label for="validationTooltip02">門市代碼</label> <input type="text"
									class="form-control" name="title" value="${upBean.store_id}"
									readonly />

							</div>
							<div class="col-md-9 mb-3">
								<label for="validationTooltip04">門市名稱</label> <input type="text"
									class="form-control" name="sname" value="${upBean.st_name} "
									required />
						...
						<div class="form-row">
							...
							<div class="col-md-9 mb-3">
								<label for="validationTooltip05">地址</label> <input type="text"
									class="form-control" name="sadd" value="${upBean.st_address}"
									required />
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">電子郵件</label> <input
									type="email" class="form-control" value="${upBean.st_mail}" name="semail" required />

							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">連絡電話</label> <input type="text"
									class="form-control" name="stel" value="${upBean.st_tel}" />

							</div>
						</div>
						<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="inputState">開始營業時間</label>
							 <select id="inputState" name="bgTime" class="form-control" required>
						...
						<div class="col-md-6 mb-3">
							<label for="inputState">結束營業時間</label>
							 <select id="inputState" name="edTime" class="form-control" required>
								<option value="00:00">00:00</option>
								<option value="01:00">01:00</option>
								<option value="02:00">02:00</option>
								<option value="03:00">03:00</option>
								...
								<label for="validationTooltip05">店休日：</label> 
								 ...
								 <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="星期日" />星期日
								   <span class="form-check-sign"></span>
      							  ...
      							  <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="星期一" />星期一 
								  <span class="form-check-sign"></span>
      							 </label>
      							 </div>
      							  ...
      							  <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="星期二" />星期二 
								  <span class="form-check-sign"></span>
      							 </label>
      							 </div>
      							  ...
      							  <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="星期三" />星期三
								  <span class="form-check-sign"></span>
      							 </label>
      							  </div>
      							  ...
      							  <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="星期四" />星期四
							      <span class="form-check-sign"></span>
      							 </label>
      							 </div>
      							  ...
      							  <div class="form-check form-check-inline">				      
							      <label class="form-check-label">
							    	<input class="form-check-input" type="checkbox" name="ckholiday" value="星期五" />星期五 
							      <span class="form-check-sign"></span>
      							 </label>
      							  </div>
      							  ...
      							  <div class="form-check form-check-inline">							     
							      <label class="form-check-label">
							    	<input class="form-check-input" type="checkbox" name="ckholiday" value="星期六" />星期六 
								  <span class="form-check-sign"></span>
      							 </label>
      							 </div>
      							  ...
      							  <div class="form-check form-check-inline">								  
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="國定假日" />國定假日 
								  <span class="form-check-sign"></span>
      							 </label>
      							 </div>
      							  ...
      							  <div class="form-check form-check-inline">
								  <label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="ckholiday" value="全年無休" />全年無休
							  	 <span class="form-check-sign"></span>
      							  </label>
								 </div>
						</div>
				...
				<div class="form-row">
					<div class="col-md-3 mb-3">
						<label for="file-uploader"> <img
							...
							id="file-uploader" name="pic1" aria-label="File browser example" require> <span
				...
				<input type='hidden' name='storeID' value='${upBean.store_id}'>
