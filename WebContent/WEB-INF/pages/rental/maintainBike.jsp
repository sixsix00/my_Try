								...
								<div class="table-responsive">
										...
										<table class="table tablesorter " id="">
											...
											<c:forEach var="TypeBean" items="${type_DPP}">
												...
												<tr>
													<td><a href=<c:url value='/rentalBike?typeId=${TypeBean.typeId}'/>>${TypeBean.typeId}</a></td>
													<td>${TypeBean.typeName}</td>
													<td class="text-right">
														<input class="btn btn-success my-2 my-sm-0" type="button" value="修改"  onclick="javascript:location.href='updateBikePre?typeId=<c:out value="${TypeBean.typeId}"/>'"/>
														<input class="btn btn-danger my-2 my-sm-0" type="button" value="刪除"   onclick="javascript:location.href='storeDelete.controller?storeID=<c:out value="${TypeBean.typeId}"/>'">
												</tr>
											</c:forEach>
