               ...
               <%@ include file="/WEB-INF/pages/global/frontEnd_top.jsp" %>
                    ...
                    <div class="container" id="div1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" style="background-color:white;border-radius:20px;" id="div1-1">
                               	<div style="margin:50px 30px;font-size:25px;padding:10px 2px">
                               	<span>訂單編號：</span><br>
                               	<span>訂單編號：</span><br>
                               	<span>訂單編號：</span><br>
                               	<span>訂單編號：</span><br>
