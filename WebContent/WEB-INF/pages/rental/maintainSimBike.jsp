								...
								<div class="table-responsive">
										...
										<table class="table tablesorter " id="">
											<thead class=" text-primary">
												<tr>
													...
													<th class="text-right"><a
														...
														href="storePreInsert"><svg width="1em"
											...
											<c:forEach var="BikeBean" items="${bike_DPP}">
												...
												<tr>
													<td><a href=<c:url value='/bikeSize?simRbId=${BikeBean.simRbId}'/>>${BikeBean.simRbId}</a></td>
													<td>${BikeBean.rbName}</td>
													<td class="text-right">
														<input class="btn btn-success my-2 my-sm-0" type="button" value="修改"  onclick="javascript:location.href='updateSimBikePre?simRbId=<c:out value="${BikeBean.simRbId}"/>'"/>
														<input class="btn btn-danger my-2 my-sm-0" type="button" value="刪除"   onclick="javascript:location.href='updateSimBikePre?simRbId=<c:out value="${BikeBean.simRbId}"/>'"/>
												</tr>
											</c:forEach>
