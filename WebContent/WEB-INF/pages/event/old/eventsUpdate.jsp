			...
			<div class="content">
				...
				<div class="row">
					...
					<form class="needs-validation w-75 m-auto"
						action="eventUpdate.controller" method="post">
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip01">EVENT_ID</label> <input
									type="text" class="form-control" id="validationTooltip01"
									value="${event.eventId}" name="eventId" readonly />
							</div>
							<div class="col-md-6 mb-3">
						...
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<label for="validationTooltip04">Category</label> <input
									...
									value="${event.eventCat.categoryId}" name="eventCat.categoryId" />
							</div>
							<div class="col-md-3 mb-3">
								<label for="validationTooltip05">Location</label> <input
									type="text" class="form-control" id="validationTooltip05"
									value="${event.location}" name="location" required />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">Location Name</label> <input
									type="text" class="form-control" id="validationTooltip05"
									value="${event.locationName}" name="locationName" required />
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">Showunit</label> <input
									type="text" class="form-control" id="validationTooltip05"
									value="${event.showunit}" name="showunit" required />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">Website</label> <input
									type="text" class="form-control" id="validationTooltip05"
									value="${event.website}" name="website" />
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-3 mb-3">
								<label for="validationTooltip04">Onsales</label> <input
									type="text" class="form-control" id="validationTooltip05"
									value="${event.onsales}" name="onsales" />
							</div>
							<div class="col-md-3 mb-3">
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<label for="validationTooltip04">Start Date</label> <input
									...
									placeholder="${event.startDate}" name="startDate" required />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationTooltip05">End Date</label> <input
									type="date" class="form-control" id="validationTooltip05"
									placeholder="${event.endDate}" name="endDate" required />
							</div>
						</div>
						<div data-spy="scroll" class="form-row">
							<label for="exampleFormControlTextarea1">Description</label>
							<textarea class="form-control" id="texta" rows="3"
								placeholder="${event.description}" name="description"
								onclick="textval()" required></textarea>
						</div>
						...
						<hr>
						<input class="btn btn-success m-2" type="button"
							value="更新" onclick='update()' />
						<button class="btn btn-warning m-2" type="reset">重置</button>
						<a class="btn btn-primary  m-2 float-right"
							href="eventMgr">返回</a> <input
							class="btn btn-danger m-2 float-right" type="button"
							value="刪除" onclick="confirmDelete()" />
					</form>
